...
public class EmployeeController {
    ...
    @PostMapping("/employee/{nametitle_id}/{gender_id}/{role_id}/{fullname}/{username}/{password}")
    public Employee newEmployee(Employee newEmployee, @PathVariable long nametitle_id, @PathVariable long gender_id,
            @PathVariable long role_id, @PathVariable String fullname, @PathVariable String username,
